...
import training.opt_tc_ae_tabular_compound as tc
import argparse
...
if __name__ == '__main__':
    ...
    parser.add_argument('--n_rots', default=64, type=int)            # 64,  64,  256,     256
    parser.add_argument('--batch_size', default=64, type=int)        # 64
    parser.add_argument('--n_epoch', default=25, type=int)           # 25,  25,  25,      25   
    parser.add_argument('--d_out', default=64, type=int)             # 64,  64,  32,      32
    parser.add_argument('--dataset', default='cn7', type=str)        # kdd, cn7, thyroid, arrhythmia
    ...
    parser.add_argument('--ndf', default=32, type=int)               # 32,  32,   8,        8
