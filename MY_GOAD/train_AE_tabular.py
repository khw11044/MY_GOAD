...
import training.opt_tc_ae_tabular as tc
import argparse
...
def load_trans_data(args):
    ...
    x_val = torch.concatenate([val_norm, val_abnorm])
    print('Data set up complete')
    
    return train_real, x_val, y_val_fscore, val_dataset, ratio, mus, sds
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='arrhythmia', type=str)        # kdd, cn7, thyroid, arrhythmia
